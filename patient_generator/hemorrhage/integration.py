...
from .hemorrhage_model import HemorrhageModel, HemorrhageProfile, HemorrhageCategory
...
class HemorrhageIntegration:
    ...
    def get_treatment_priority(self, hemorrhage_data: Dict) -> str:
        ...
        if time_to_critical < 10:  # Less than 10 minutes
            return "T1"
        elif time_to_critical < 30:  # Less than 30 minutes
            return "T2"
        else:
            return "T3"
    ...
    def _get_hemorrhage_status(blood_volume_percent: float) -> str:
        ...
        if blood_volume_percent >= 85:
            return "stable"
        elif blood_volume_percent >= 70:
            return "compensated_shock"
        elif blood_volume_percent >= 50:
            return "decompensated_shock"
        elif blood_volume_percent >= 40:
            return "critical"
        else:
