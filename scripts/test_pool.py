...
def test_performance():
    ...
    try:
        ...
        print(f"  - Avg query time: {metrics['queries']['avg_time_ms']:.2f}ms")
        print(f"  - Pool efficiency: {metrics['connections']['created']} connections for {metrics['checkouts']['total']} checkouts")
        
        # Check for connection reuse
        efficiency = (metrics['checkouts']['total'] - metrics['connections']['created']) / metrics['checkouts']['total'] * 100
