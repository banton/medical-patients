...
class TreatmentProtocolManager:
    ...
    def _initialize_protocols(self) -> Dict[str, TreatmentProtocol]:
        ...
        protocols["125596004"] = TreatmentProtocol(
            ...
            categories=[TreatmentCategory.HEMORRHAGE_CONTROL, TreatmentCategory.AIRWAY_MANAGEMENT, 
    ...
    def _map_treatments_by_category(self) -> Dict[TreatmentCategory, Set[str]]:
        ...
        return {
            TreatmentCategory.HEMORRHAGE_CONTROL: {
                "tourniquet", "pressure_bandage", "hemostatic_gauze", 
                "blood_transfusion", "massive_transfusion_protocol"
            },
            TreatmentCategory.AIRWAY_MANAGEMENT: {
                "airway_positioning", "intubation", "surgical_airway",
                "needle_decompression", "oxygen_therapy"
            },
            TreatmentCategory.CIRCULATION_SUPPORT: {
                "iv_access", "iv_fluids", "blood_transfusion",
                "vasopressors", "warm_fluids"
            },
            TreatmentCategory.TRAUMA_SURGERY: {
                "damage_control_surgery", "definitive_surgery",
                "surgical_debridement", "wound_closure"
            },
            TreatmentCategory.BURN_CARE: {
                "burn_dressing", "burn_resuscitation", "escharotomy",
                "burn_surgery", "skin_grafting"
            },
            TreatmentCategory.NEUROLOGICAL: {
                "neurological_monitoring", "icp_monitoring", "mannitol",
                "neurosurgery", "craniotomy", "seizure_prophylaxis"
            },
            TreatmentCategory.INFECTION_PREVENTION: {
                "antibiotics", "broad_spectrum_antibiotics", "targeted_antibiotics",
                "wound_irrigation", "tetanus_prophylaxis"
            },
            TreatmentCategory.PAIN_MANAGEMENT: {
                "pain_management", "regional_anesthesia", "ketamine",
                "morphine", "fentanyl"
            },
            TreatmentCategory.STABILIZATION: {
                "splinting", "c_spine_immobilization", "pelvic_binder",
                "chest_tube", "shock_position"
            }
        }
    ...
    def get_treatment_sequence(
        self,
        snomed_code: str,
        facilities_visited: List[FacilityLevel]
