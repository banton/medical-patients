...
class TestMetricsMiddleware:
    ...
    def test_request_metrics_collection(self, client):
        ...
        assert any("GET /test 200" in k for k in metrics.keys())
        assert any("GET /test/:id 200" in k for k in metrics.keys())
    ...
    def test_error_metrics_collection(self, client):
        ...
        assert any("GET /error 400" in k for k in metrics.keys())
    ...
    def test_path_normalization(self, client):
        ...
        # Test configurations
        assert middleware._normalize_path("/api/v1/configurations/abc-123") == "/api/v1/configurations/:configuration_id"
