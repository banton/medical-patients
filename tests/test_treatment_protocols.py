...
import pytest
from medical_simulation.treatment_protocols import (
...
class TestTreatmentProtocolManager:
    ...
    def test_validate_treatment_combination(self):
        ...
        assert self.manager.validate_treatment_combination(
            valid_treatments, "262574004"
        ) is True
        
        # Invalid combination for burn (tourniquet contraindicated)
        invalid_treatments = ["tourniquet", "burn_dressing"]
        assert self.manager.validate_treatment_combination(
            invalid_treatments, "7200002"
        ) is False
    ...
    def test_treatment_categories_mapping(self):
        ...
        hemorrhage_treatments = self.manager.treatment_by_category[
        ...
        airway_treatments = self.manager.treatment_by_category[
