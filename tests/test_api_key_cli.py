...
from scripts.api_key_cli import main, APIKeyCLI
...
class TestCLICommands:
    ...
    @patch('scripts.api_key_cli.cli_app.cleanup')
    @patch('scripts.api_key_cli.cli_app.session_factory')
    def test_activate_command_already_active(self, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
    ...
    @patch('scripts.api_key_cli.cli_app.cleanup')
    @patch('scripts.api_key_cli.cli_app.session_factory')
    def test_deactivate_command_success(self, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
    ...
    def test_delete_command_with_confirmation(self, mock_confirm, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
    ...
    @patch('scripts.api_key_cli.cli_app.session_factory')
    @patch('rich.prompt.Confirm.ask')
    def test_delete_command_cancelled(self, mock_confirm, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
    ...
    @patch('scripts.api_key_cli.cli_app.cleanup')
    @patch('scripts.api_key_cli.cli_app.session_factory')
    def test_delete_command_with_confirm_flag(self, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
    ...
    @patch('scripts.api_key_cli.cli_app.session_factory')
    @patch('rich.prompt.Confirm.ask')
    def test_rotate_command_success(self, mock_confirm, mock_session_factory, mock_cleanup, mock_initialize, runner, mock_api_key):
