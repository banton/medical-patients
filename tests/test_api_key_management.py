...
class TestAPIKeyRepository:
    ...
    def test_create_api_key(self, api_key_repo):
        ...
        api_key = api_key_repo.create_api_key(
            name="Test Client", email="client@example.com", max_patients_per_request=500
        )
    ...
    def test_create_demo_key(self, api_key_repo):
        ...
        demo_key = api_key_repo.create_api_key(name="Demo Key", is_demo=True, max_patients_per_request=50)
...
class TestAPIKeyContext:
    ...
    def test_context_creation(self):
        ...
        api_key = APIKey(key="test_context", name="Context Test", max_patients_per_request=100)
    ...
    def test_patient_limit_enforcement(self):
        ...
        api_key = APIKey(key="limit_test", name="Limit Test", max_patients_per_request=50)
    ...
    def test_daily_limit_enforcement(self):
        ...
        under_limit_key = APIKey(key="under_limit", name="Under Limit", max_requests_per_day=100, daily_requests=50)
