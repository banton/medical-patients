...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "Available Nationalities:", json.dumps(nationalities[:5], indent=2) + "..." if nationalities else "[]"
        )  # Print first 5
        ...
        new_config_payload = {
            ...
            "injury_distribution": {"Battle Injury": 60.0, "Disease": 25.0, "Non-Battle Injury": 15.0},
