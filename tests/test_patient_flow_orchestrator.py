...
from medical_simulation.patient_flow_orchestrator import (
    PatientFlowOrchestrator, PatientState, Patient
)
...
class TestPatientFlowOrchestrator:
    ...
    def test_apply_treatment_death(self):
        ...
        treatments = [{"name": "basic_bandage", "applied_at": datetime.now()}]
    ...
    def test_complete_transport_success(self):
        ...
        # Schedule transport
        transport_id = self.orchestrator.transport_patient("P008", "Role2")
    ...
    def test_get_system_status(self):
        ...
        p1 = self.orchestrator.initialize_patient("P011", "gunshot", "critical", "POI")
        p2 = self.orchestrator.initialize_patient("P012", "blast", "moderate", "POI")
        p3 = self.orchestrator.initialize_patient("P013", "burn", "minor", "POI")
