...
class TestAPIKeyContextCreation:
    ...
    def test_context_creation_with_rate_limits(self):
        ...
        context = APIKeyContext(api_key=api_key, rate_limit_remaining=45, rate_limit_reset=reset_time)
...
class TestAPIKeyContextLimitChecking:
    ...
    def test_check_daily_limit_success(self):
        ...
        api_key = APIKey(key="test", name="Test", max_requests_per_day=100, daily_requests=50)
        context = APIKeyContext(api_key=api_key)
    ...
    def test_check_daily_limit_failure(self):
        ...
        api_key = APIKey(key="test", name="Test", max_requests_per_day=100, daily_requests=100)
        context = APIKeyContext(api_key=api_key)
...
class TestAPIKeyContextUsabilityChecking:
    ...
    def test_check_usability_expired(self):
        ...
        api_key = APIKey(key="test", name="Test", is_active=True, expires_at=datetime.utcnow() - timedelta(days=1))
        context = APIKeyContext(api_key=api_key)
