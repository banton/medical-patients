...
class DisabilityTracker:
    ...
    def can_return_to_duty(
        ...
        if days_since_injury < criteria["minimum_recovery_days"]:
            return False, f"Insufficient recovery time: {days_since_injury} days (need {criteria['minimum_recovery_days']})"
        ...
        for disability in patient_disabilities:
            if disability in criteria["conditional_rtd"]:
                ...
                elif condition == "after_treatment" and psychological_status == "treated":
    ...
    def get_max_recovery_potential(
        self,
