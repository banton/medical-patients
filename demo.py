...
def main():
    ...
    config = {
        ...
        "nationality_distribution": {
            "Polish": {"POL": 0.50, "GBR": 0.10, "LIT": 0.30, "USA": 0.05, "ESP": 0.05},
            "Estonian": {"EST": 0.70, "GBR": 0.30},
            "Finnish": {"FIN": 0.40, "USA": 0.60},
        },
        "injury_distribution": {"DISEASE": 0.52, "NON_BATTLE": 0.33, "BATTLE_TRAUMA": 0.15},
    ...
    for patient in patients:
        ...
        patient.additional_conditions = condition_generator.generate_additional_conditions(
            primary_condition, additional_count
        )
