...
class GenerationBenchmark:
        ...
        for config in test_configs:
            ...
            try:
                ...
                if result['chunked_generation']:
                    print(f"  ✅ Used chunked generation (1000 patients/chunk)")
    ...
    def _print_summary(self):
        ...
        print(f"  Streaming writes with aiofiles: Enables handling of 100K+ patients")
        print(f"  Periodic flush (every 100 patients): Prevents memory accumulation")
